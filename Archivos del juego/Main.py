...
sound_llave=pygame.mixer.Sound("music/EFECTOLLAVE.mp3")
sound_llave.set_volume(1.0)
sound_fondo=pygame.mixer.Sound("music/FONDO.mp3")
sound_fondo.set_volume(0.5)
sound_menu=pygame.mixer.Sound("music/MENUMUSICA.mp3")
